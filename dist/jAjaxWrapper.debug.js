...
(function (global, factory) {
	...
	var require$$0 = getCjsExportFromNamespace(bignumber);
	...
	*/
	...
	// Produce a string from holder[key].
	        ...
	        var i,          // The loop counter.
	            ...
	            partial,
	            value = holder[key],
	            isBigNumber = value != null && (value instanceof require$$0 || require$$0.isBigNumber(value));
	...
	*/
	...
	var jAjaxWrapper = function jAjaxWrapper(jQuery, Axios, rewriteResponse) {
	  if (rewriteResponse) {
	    // 增加Axios配置
